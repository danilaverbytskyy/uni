...
students = [
    # №, Фамилия, Пол (М=1, Ж=0), Зачеты (Да=1, Нет=0), История, Графика, Матем, Химия, Физика, Стипендия
...
# Извлекаем входные данные (x1-x7) и стипендию (x8)
...
class KohonenNetwork:
    def __init__(self, input_size, output_size):
        # Инициализируем веса случайными значениями от 0 до 1
    ...
    def train(self, data, epochs=6, initial_rate=0.3, decay=0.05):
        for epoch in range(epochs):
            ...
            for sample in data:
                # Находим нейрон-победитель (с минимальным расстоянием)
